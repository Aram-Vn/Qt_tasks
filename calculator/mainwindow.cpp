...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    else if(e->key() == Qt::Key_Delete || e->key() == Qt::Key_Delete)
    {
...
void MainWindow::buttonClicked_handler(QString str)
{
    ...
    if(str.contains(operator_reg))
    {
        ...
        if(m_flag_first_operand_isempty && !display->text().isEmpty())
        {
            ...
            qDebug() << "first if p1 226: " << str << " : " << m_first_operand;
            return;
        }
    ...
    if(str == "=")
    {
        ...
        {
            qDebug() << "= if p1 262 p3 : " << m_first_operand << " " << m_second_operand;
